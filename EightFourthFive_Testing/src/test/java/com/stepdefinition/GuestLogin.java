...
public class GuestLogin extends BaseClass {
	...
	@When("User Click The {string} Theme button")
	public void user_click_the_theme_button(String string) throws InterruptedException {

		driver.findElement(By.xpath("//li[@class='" + string + "']"));
		Thread.sleep(2000);
	}
...
//	}
	...
	public void user_mouseover_click_the_chart(String string) throws InterruptedException {
		...
		WebElement element = driver.findElement(By.xpath("//ul[@class='select-list']//descendant::span[text()='"+string+"']"));
		...
		driver.findElement(By.xpath("//ul[@class='select-list']//descendant::span[@data-symbol='"+string+"']")).click();
	...
	@When("User Click Minutes {string}")
	public void user_click_minutes(String string) throws InterruptedException {
	...
	@When("User Navigate to Frame for Charts")
	public void user_navigate_to_frame_for_charts() {
		framesHandling();

	}
	
	@When("User Close the Charts")
	public void user_close_the_charts() throws InterruptedException {
		Thread.sleep(2000);
	...
	@When("User Click Bar Charts")
	public void user_click_bar_charts() throws InterruptedException {
	...
	@When("User Select {string} and Check")
	public void user_select_and_check(String string) throws InterruptedException {
	  
		driver.findElement(By.xpath("//div[@data-name='menu-inner']//descendant::div[text()='"+string+"']")).click();
		Thread.sleep(1000);
	}
	


	@When("User Come out of the Frame")
	public void user_come_out_of_the_frame() {
	...
	public void navigate_to_home_page_guest_user() throws InterruptedException {
